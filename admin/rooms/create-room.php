...
if (isset($_POST['submit'])) {
    ...
    if ($row_cnt > 0) {
        ...
        $query = "insert into  rooms (seater,room_no,floor) values(?,?,?)";
        $stmt = $mysqli->prepare($query);
        $rc = $stmt->bind_param('iii', $seater, $roomno, $floor);
        $stmt->execute();
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2 class="page-title">Add a Room
                            </h2>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="post" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Select Seater
                                                    </label>
                                                    <div class="col-sm-8">
